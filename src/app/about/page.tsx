        ...
        <>
            ...
            <div className="flex flex-col justify-center items-center p-6 bg-slate-50 mx-8 sm:mx-20 mt-4 sm:mt-10 rounded-xl shadow-md">
                ...
                <div className="flex flex-col text-lg sm:flex-row-reverse justify-between align-middle gap-6 sm:gap-16 sm:mx-40 mt-10">
                    <Image className="object-cover self-center sm:self-end rounded-md w-[200px] h-[200px]" width={370} height={370} alt="sofaImage" src="/static/img/sofaCover2.jpeg" />
                    <div className="flex flex-col gap-4 text-[14px]"><span>Welcome to Amante Tassels, where style meets functionality in the world of home decor. At Amante Tassels, we take pride in transforming your living spaces into vibrant and inviting sanctuaries. As purveyors of exquisite sofa covers and table covers, we bring you a curated collection that combines elegance with practicality, ensuring that your home reflects your unique personality.</span>
                ...
                <div className="flex flex-col text-lg sm:flex-row-reverse justify-between align-middle gap-6 sm:gap-16 sm:mx-40 mt-10">
                    <Image className="object-cover self-center sm:self-end rounded-md w-[200px] h-[200px]" width={370} height={370} alt="sofaImage" src="/static/img/sofaCover3.jpeg" />
